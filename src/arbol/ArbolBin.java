...
public class ArbolBin {
    ...
    public void Insertarnombre(Persona d) {
    ...
    public void InOrden(NodoArbol r) {
        ...
        if (r != null) {
            InOrden(r.izq);
            System.out.println("nombre" + r.dato.Nombre() + "edad" + r.dato.Edad() + "ident" + r.dato.Ident());
            InOrden(r.der);
        }
    }
    ...
    public NodoArbol BuscarNodo(Persona d) {
        NodoArbol aux = raiz;
        while (aux.dato != d) {
    ...
    public NodoArbol ObtenerRemplazo(NodoArbol nodoreemplazo) {
        ...
        System.out.println("El nodo a remplazar es:" + reemplazo.dato.Nombre());
        return reemplazo;
    }
    ...
    public void hermanos(NodoArbol raiz) {
        ...
        if (raiz != null) {
            while (Aux.izq != null && Aux.der != null) {
                System.out.println("hermno" + Aux.der.dato.Nombre() + "-" + Aux.izq.dato.Nombre());
                Aux = Aux.izq;
                if (Aux == null) {
